...
const MOTIONS = [
  {
    ...
    sources: [
      { label: "נספח 8: ר\"ח אגמי לביא (כתב התביעה)", file: "/docs/ktav-tvia.pdf#page=125", note: "גיא ארוסי, אגמי לביא: ₪25,769 הפרשי הצמדה וריבית מקסימליים — עמ' 127 מסכם: 8,115 + 9,479 + 8,175 = ₪25,769 סה\"כ. אפילו ר\"ח מטעם רון לא מוצא בסיס לסכום גבוה יותר" },
    ],
  ...
  },
  {
    ...
    sources: [
      { label: "החלטת בית המשפט 3.12.2024", file: "/docs/ktav-tvia.pdf#page=76", note: "₪52,891.45: חוב שרבט לאחר קיזוז פיקדונות — נספח 5ג לכתב התביעה, עמ' 76-77" },
