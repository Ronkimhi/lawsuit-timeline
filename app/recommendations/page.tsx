...
const MOTIONS = [
  {
    ...
    what: "להפקיד ₪25,769 (סכום שמאי שרבט עצמו, נספח 8 בכתב התביעה) בנאמנות נוה גור, עם הסתייגות מפורשת 'בלא הודאה בחבות'. זה מסיר את הפרטנסיה הכספית האחרונה ומאפשר לבית המשפט לשאול: 'שרבט, למה אתה עוד מחזיק את הטאבו?'",
    basis: "נספח 8 לכתב התביעה: ר\"ח מטעם רון עצמו מצא ₪25,769 לכל היותר. אפילו ר\"ח של התובעים לא מוצא בסיס לסכום גבוה יותר. בקשה מוגשת 24.5.2026, ממתינה לאישור בית משפט. שרבט עדיין חייב לרון ₪52,891 (מ-3.12.2024), יותר מ-₪25,769, כך שהסכום יקוזז. הפקדה: 'לפנים משורת הדין', 'בלא הודאה בחבות'.",
    exhibits: [
      "₪25,769: סכום מדויק מנספח 8 בכתב התביעה (שמאי שרבט עצמו)",
